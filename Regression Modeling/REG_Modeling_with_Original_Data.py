...
features_used = features_org # (or features_rd, features_plus) which is used in following ML model. in following ML model.
...
ref_metrics_lasso_O = reform_reg_metrics('LASSO', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_lasso_O

plot_features_weights('LASSO(O)', lasso.coef_, X_train.columns, 'c')
plot_residual('LASSO(O)', y_train_predict, y_train, y_test_predict, y_test)
...
ref_metrics_rdg_O = reform_reg_metrics('Ridge', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_rdg_O

plot_features_weights('Ridge(O)', rdg.coef_, X_train.columns, 'c')
plot_residual('Ridge(O)', y_train_predict, y_train, y_test_predict, y_test)
...
ref_metrics_poly_O = reform_reg_metrics('Polynomial', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_poly_O

# cause the weight matrix of "weight matrix" are too large to plot by plot_features_weights()
# so we did not plot weight matrix
plot_residual('Polynomial(O)', y_train_predict, y_train, y_test_predict, y_test)
...
ref_metrics_dtrg_O = reform_reg_metrics('Decision Tree', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_dtrg_O

plot_features_weights('Decision Tree(O)', dtrg.feature_importances_, X_train.columns, 't')
plot_residual('Decision Tree(O)', y_train_predict, y_train, y_test_predict, y_test)
...
ref_metrics_rf_O = reform_reg_metrics('Random Forest', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_rf_O

plot_features_weights('Random Forest(O)', rf.feature_importances_, X_train.columns, 't')
plot_residual('Random Forest(O)', y_train_predict, y_train, y_test_predict, y_test)


# -----------------------------------------------------------------------------
# XGBoost

xgb = XGBRegressor(max_depth = 7, learning_rate = 0.01, reg_alpha = 1, reg_lambda = 0) # features_org
...
# reform a metrics of Random Forest
ref_metrics_xgb_O = reform_reg_metrics('XGBoost', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_xgb_O

plot_features_weights('XGBoost(O)', xgb.feature_importances_, X_train.columns, 't')
plot_residual('XGBoost(O)', y_train_predict, y_train, y_test_predict, y_test)
...
mlp = MLPRegressor(alpha = 0.1, learning_rate = 'adaptive', random_state = 51)
...
ref_metrics_mlp_O = reform_reg_metrics('Neural Network', 'Original',
                   y_test, y_test_predict, y_train, y_train_predict)
ref_metrics_mlp_O

# cause the weight matrix of "weight matrix" are too large to plot by plot_features_weights()
# so just like Polynomial Regression, we did not plot weight matrix
plot_residual('Neural Network(O)', y_train_predict, y_train, y_test_predict, y_test)
